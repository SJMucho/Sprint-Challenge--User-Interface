...
Semantic HTML describes tags with meaning. 
...
It makes it easy to collaborate with anyone anywhere while saving all drafts/versions which can be helpful for going back, finding errors and fixing bugs, etc.

5. Define mobile-first design in your own words.

Mobile first design is building a site with a small mobile phone screen in mind.
